...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Special Education Professional Development Nexus";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Professional Development Program";
process.env.TABLE_NAME = process.env.TABLE_NAME || "professional_development_program_records";
'use strict';
